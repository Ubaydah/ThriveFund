-- ThriveFund Seed Data (development/demo)
...
('usr_demo_admin01', 'Admin User', 'admin@thrivefund.ng', '+2348000000001',
 '$2a$10$L55p50RZCrEpqzXICvPKMuFt0ziBNoc11XoPJKYbWIoWRU.YScu7q', 'admin');

-- Demo organization owner (password: DemoPass123!)
INSERT IGNORE INTO users (id, full_name, email, phone_number, password_hash, role) VALUES
('usr_demo_adebayo', 'Adebayo Okonkwo', 'adebayo@thrivefund.ng', '+2348034567890',
 '$2a$10$L55p50RZCrEpqzXICvPKMuFt0ziBNoc11XoPJKYbWIoWRU.YScu7q', 'user');

INSERT IGNORE INTO notification_preferences (user_id) VALUES ('usr_demo_adebayo');

INSERT IGNORE INTO organizations (id, name, slug, type, description, owner_id) VALUES
('org_demo_mosque01', 'Lagos Central Mosque', 'lagos-central-mosque', 'mosque',
 'Community mosque collecting Jumu''ah and renovation funds', 'usr_demo_adebayo');

INSERT IGNORE INTO organization_members (id, organization_id, user_id, role) VALUES
('om_demo_owner001', 'org_demo_mosque01', 'usr_demo_adebayo', 'owner');
...
('goal_demo_water01', 'usr_demo_adebayo', 'org_demo_mosque01',
...
('goal_demo_nysc001', 'usr_demo_adebayo', NULL,
 'NYSC Relocation Fund', 'Saving for relocation after NYSC', 300000.00, 0.00,
 'personal', 'active', '2024-06-30', 'nysc-relocation-fund');

-- Note: virtual accounts are created via API (MockNombaProvider) after seed.
-- Use POST /api/webhooks/mock/simulate to test payment flow with account_number from VA creation.
